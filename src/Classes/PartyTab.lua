...
function PartyTabClass:PartyTab(build)
	...
	self.controls.importCodeHeader = new("LabelControl"):LabelControl({ "TOPLEFT", self.controls.notesDesc, "BOTTOMLEFT" }, { 0, 32, 0, theme.stringHeight }, i18n.t("party.ui.importCodeHeader"))
	...
	self.controls.importCodeDestination = new("DropDownControl"):DropDownControl({ "TOPLEFT", self.controls.importCodeIn, "BOTTOMLEFT" }, { 0, 4, 160, theme.buttonHeight }, partyDestLabels)
	self.controls.importCodeDestination.tooltipText = i18n.t("party.tooltips.destination")
	self.controls.importCodeGo = new("ButtonControl"):ButtonControl({ "LEFT", self.controls.importCodeDestination, "RIGHT" }, { 8, 0, 160, theme.buttonHeight }, i18n.t("party.buttons.import"), function()
	...
	self.controls.appendNotReplace = new("CheckBoxControl"):CheckBoxControl({ "LEFT", self.controls.importCodeGo, "RIGHT" }, { 60, 0, theme.buttonHeight }, i18n.t("party.buttons.append"), function(state)
	...
	self.controls.clear = new("ButtonControl"):ButtonControl({ "LEFT", self.controls.appendNotReplace, "RIGHT" }, { 8, 0, 160, theme.buttonHeight }, i18n.t("party.buttons.clear"), function()
		clearInputText()
		wipeTable(self.enemyModList)
		self.enemyModList = new("ModList"):ModList()
		self.build.buildFlag = true
	...
	self.controls.ShowAdvanceTools = new("CheckBoxControl"):CheckBoxControl({ "TOPLEFT", self.controls.importCodeDestination, "BOTTOMLEFT" }, { 140, 4, theme.buttonHeight }, i18n.t("party.buttons.showAdvancedInfo"), function(state)
	...
	self.controls.removeEffects = new("ButtonControl"):ButtonControl({ "LEFT", self.controls.ShowAdvanceTools, "RIGHT" }, { 8, 0, 160, theme.buttonHeight }, i18n.t("party.buttons.disablePartyEffects"), function()
	...
	self.controls.rebuild = new("ButtonControl"):ButtonControl({ "LEFT", self.controls.removeEffects, "RIGHT" }, { 8, 0, 160, theme.buttonHeight }, i18n.t("party.buttons.rebuildAll"), function()
		wipeTable(self.actor)
		wipeTable(self.enemyModList)
		self.actor = { Aura = {}, Curse = {}, Warcry = { }, Link = {}, modDB = new("ModDB"):ModDB(), output = { } }
		self.actor.modDB.actor = self.actor
	...
	self.controls.editAurasLabel = new("LabelControl"):LabelControl({ "TOPLEFT", self.controls.ShowAdvanceTools, "TOPLEFT" }, { -140, 40, 0, theme.stringHeight }, i18n.t("party.headers.auras"))
	...
	self.controls.editWarcriesLabel = new("LabelControl"):LabelControl({ "TOPLEFT", self.controls.editAurasLabel, "BOTTOMLEFT" }, { 0, 8, 0, theme.stringHeight }, i18n.t("party.headers.warcries"))
	...
	self.controls.editLinksLabel = new("LabelControl"):LabelControl({ "TOPLEFT", self.controls.editWarcriesLabel, "BOTTOMLEFT" }, { 0, 8, 0, theme.stringHeight }, i18n.t("party.headers.linkSkills"))
	...
	self.controls.editPartyMemberStatsLabel = new("LabelControl"):LabelControl({ "TOPLEFT", self.controls.notesDesc, "TOPRIGHT" }, { 8, 0, 0, theme.stringHeight }, i18n.t("party.headers.partyMemberStats"))
	...
	self.controls.enemyCondLabel = new("LabelControl"):LabelControl({ "TOPLEFT", self.controls.editPartyMemberStatsLabel, "BOTTOMLEFT" }, { 0, 8, 0, theme.stringHeight }, i18n.t("party.headers.enemyConditions"))
	...
	self.controls.enemyModsLabel = new("LabelControl"):LabelControl({ "TOPLEFT", self.controls.enemyCondLabel, "BOTTOMLEFT" }, { 0, 8, 0, theme.stringHeight }, i18n.t("party.headers.enemyModifiers"))
	...
	self.controls.editCursesLabel = new("LabelControl"):LabelControl({ "TOPLEFT", self.controls.enemyModsLabel, "BOTTOMLEFT" }, { 0, 8, 0, theme.stringHeight }, i18n.t("party.headers.curses"))
