...
itemBases["[DNT] Slivered Flail"] = {
	type = "Flail",
	quality = 20,
	socketLimit = 3,
	tags = { default = true, flail = true, one_hand_weapon = true, onehand = true, weapon = true, },
	implicitModTypes = { },
	weapon = { PhysicalMin = 37, PhysicalMax = 68, CritChanceBase = 10, AttackRateBase = 1.45, Range = 11, },
	req = { level = 67, str = 89, int = 36, },
}
itemBases["[DNT] Shackled Flail"] = {
	type = "Flail",
	quality = 20,
	socketLimit = 3,
	tags = { default = true, flail = true, one_hand_weapon = true, onehand = true, weapon = true, },
	implicitModTypes = { },
	weapon = { PhysicalMin = 39, PhysicalMax = 72, CritChanceBase = 10, AttackRateBase = 1.45, Range = 11, },
	req = { level = 72, str = 89, int = 36, },
}
itemBases["[DNT] Righteous Flail"] = {
	type = "Flail",
	quality = 20,
	socketLimit = 3,
	tags = { default = true, flail = true, one_hand_weapon = true, onehand = true, weapon = true, },
	implicitModTypes = { },
	weapon = { PhysicalMin = 41, PhysicalMax = 76, CritChanceBase = 10, AttackRateBase = 1.45, Range = 11, },
	req = { level = 77, str = 89, int = 36, },
}
itemBases["[DNT] Ferric Flail"] = {
	type = "Flail",
	quality = 20,
	socketLimit = 3,
	tags = { default = true, flail = true, one_hand_weapon = true, onehand = true, weapon = true, },
	implicitModTypes = { },
	weapon = { PhysicalMin = 41, PhysicalMax = 76, CritChanceBase = 10, AttackRateBase = 1.45, Range = 11, },
	req = { level = 78, str = 89, int = 36, },
}
itemBases["[DNT] Twofold Flail"] = {
	type = "Flail",
	quality = 20,
	socketLimit = 3,
	tags = { default = true, flail = true, one_hand_weapon = true, onehand = true, weapon = true, },
	implicitModTypes = { },
	weapon = { PhysicalMin = 41, PhysicalMax = 76, CritChanceBase = 10, AttackRateBase = 1.45, Range = 11, },
	req = { level = 79, str = 89, int = 36, },
}
itemBases["[DNT] Winding Flail"] = {
	type = "Flail",
	quality = 20,
	socketLimit = 3,
	tags = { default = true, flail = true, one_hand_weapon = true, onehand = true, weapon = true, },
...
itemBases["[DNT] Boulder Flail"] = {
	type = "Flail",
	quality = 20,
	socketLimit = 3,
	tags = { default = true, flail = true, one_hand_weapon = true, onehand = true, weapon = true, },
	implicitModTypes = { },
	weapon = { PhysicalMin = 40, PhysicalMax = 74, CritChanceBase = 10, AttackRateBase = 1.45, Range = 11, },
	req = { level = 75, str = 89, int = 36, },
}
itemBases["[DNT] Banded Flail"] = {
	type = "Flail",
	quality = 20,
	socketLimit = 3,
	tags = { default = true, flail = true, one_hand_weapon = true, onehand = true, weapon = true, },
