...
function listMode:Init(selBuildName, subPath)
	...
	self.controls.open.enabled = function() return self.controls.buildList and self.controls.buildList.selValue ~= nil end
	...
	self.controls.copy.enabled = function() return self.controls.buildList and self.controls.buildList.selValue ~= nil end
	...
	self.controls.rename.enabled = function() return self.controls.buildList and self.controls.buildList.selValue ~= nil end
	...
	self.controls.delete.enabled = function() return self.controls.buildList and self.controls.buildList.selValue ~= nil end
	...
	local buildListWidth = function ()
		...
		if false then
			...
			return 900  -- Windows default fixed width
		end
	end
